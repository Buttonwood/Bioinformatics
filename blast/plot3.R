...
barplot_with_pareto(data[,2],main="Query Coverage Counts", xlab="Query Coverage(%)")
barplot_with_pareto(data[,3],main="Query Aln rate Counts", xlab="Query Aln rate(%)")
barplot_with_pareto(data[,4],main="Target Coverage Counts",xlab="Target Coverage(%)")
barplot_with_pareto(data[,4],main="Target Aln rate Counts",xlab="Target Aln rate(%)")
